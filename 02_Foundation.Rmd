...
In addition to the datatypes, there are two types of _flags_:   
...
It is important to note that the **category** datatype requires special handling. Each field of this datatype is defined by a vector of permissible values, also known as a _valueset_. Therefore a prequisite for a quality process for this datatype is knowing the valueset that constrains the range of possible values. From a maintenance perspective, *category* fields require iterative updates with new allowable values added to the valueset. 
